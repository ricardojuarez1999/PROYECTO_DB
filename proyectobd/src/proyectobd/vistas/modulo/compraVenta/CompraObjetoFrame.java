...
public class CompraObjetoFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        totalFacturaProducto = new javax.swing.JLabel();
        ...
        jLabel1.setText("COMPRA DE OBJETO");
        ...
        totalFacturaProducto.setBackground(new java.awt.Color(252, 100, 68));
        totalFacturaProducto.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        totalFacturaProducto.setForeground(new java.awt.Color(252, 100, 68));
        totalFacturaProducto.setText("TOTAL A PAGAR: Q  0.00");
        totalFacturaProducto.setToolTipText("");
        jPanel1.add(totalFacturaProducto, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 480, 270, 30));
    ...
    private void realizarCompraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_realizarCompraActionPerformed
        ...
        if ((float) saldo > (float) DetalleProducto.total) {
            ...
            facturaProducto.setIdProveedor(producto.getIdProveedor());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CompraObjetoFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CompraObjetoFrame().setVisible(true);
            }
        });
    }
    ...
    public static javax.swing.JLabel totalFacturaProducto;

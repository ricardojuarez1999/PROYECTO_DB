 ...
 * @author israe
 */
public class ConsultarEquip extends javax.swing.JFrame {
    ...
    /**
     * Creates new form ConsultarEquip
     */
    public ConsultarEquip() {
        initComponents();
    ...
    public ConsultarEquip(String regreso,Empleado info) {
        initComponents();
        this.setLocationRelativeTo(null);
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel44, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 250, 370, -1));
        ...
        jLabel15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/proyectobd/vistas/imagenes/icon_id_32px.png"))); // NOI18N
        ...
        jLabel45.setText("Consultar Equipo");
        ...
        jPanel2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 300, 680, 200));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultarEquip.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultarEquip().setVisible(true);
            }
        });
    }
